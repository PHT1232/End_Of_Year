...
namespace Nguyen_Tan_Phat_Project.Migrations
{
    ...
    [Migration("20230510085955_initial_5")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nguyen_Tan_Phat_Project.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Nguyen_Tan_Phat_Project.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Nguyen_Tan_Phat_Project.Entities.Category", b =>
                {
            ...
            modelBuilder.Entity("Nguyen_Tan_Phat_Project.Entities.ExportImportProduct", b =>
                {
                    ...
                    b.ToTable("exportImportProduct");
                });

            modelBuilder.Entity("Nguyen_Tan_Phat_Project.Entities.OrgCustomer", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("OrgCustomerAddress")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("OrgCustomerDescription")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("OrgCustomerEmail")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("OrgCustomerName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("OrgCustomerPhone")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("OrgCustomerWebsite")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("orgCustomer");
                });

            modelBuilder.Entity("Nguyen_Tan_Phat_Project.Entities.Product", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Nguyen_Tan_Phat_Project.Entities.Structure", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("LevelOfUnit")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("UnitName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("UnitOf")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Nguyen_Tan_Phat_Project.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Nguyen_Tan_Phat_Project.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Nguyen_Tan_Phat_Project.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Nguyen_Tan_Phat_Project.Authorization.Roles.Role", b =>
                {
                    b.HasOne("Nguyen_Tan_Phat_Project.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("Nguyen_Tan_Phat_Project.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("Nguyen_Tan_Phat_Project.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Nguyen_Tan_Phat_Project.Entities.Product", b =>
                {
                    b.HasOne("Nguyen_Tan_Phat_Project.Entities.Category", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryId");

                    b.HasOne("Nguyen_Tan_Phat_Project.Entities.SubCategory", "SubCategory")
                        .WithMany()
