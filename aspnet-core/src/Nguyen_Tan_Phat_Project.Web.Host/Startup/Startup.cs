...
namespace Nguyen_Tan_Phat_Project.Web.Host.Startup
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAbpWithoutCreatingServiceProvider<Nguyen_Tan_Phat_ProjectWebHostModule>(
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(options =>
            {
                ...
                options.SwaggerEndpoint($"/aspnet/swagger/{_apiVersion}/swagger.json", $"Nguyen_Tan_Phat_Project API {_apiVersion}");
        ...
        private void ConfigureSwagger(IServiceCollection services)
        {
            services.AddSwaggerGen(options =>
            {
                ...
                {
                    Version = _apiVersion,
                    Title = "Nguyen_Tan_Phat_Project API",
                    Description = "Nguyen_Tan_Phat_Project",
                    // uncomment if needed TermsOfService = new Uri("https://example.com/terms"),
                    Contact = new OpenApiContact
                    {
                        Name = "Nguyen_Tan_Phat_Project",
                        Email = string.Empty,
                ...
                if (canShowSummaries)
                {
                    ...
                    var applicationXml = $"Nguyen_Tan_Phat_Project.Application.xml";
                    var applicationXmlPath = Path.Combine(AppContext.BaseDirectory, applicationXml);
                    options.IncludeXmlComments(applicationXmlPath);

                    var webCoreXmlFile = $"Nguyen_Tan_Phat_Project.Web.Core.xml";
